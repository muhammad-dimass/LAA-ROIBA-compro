...
$banner = mysqli_query($koneksi, "SELECT * FROM frontend WHERE Kategory = 'banner' ");

?>

 <div class="order">
                    <div class="head" style="margin-bottom:30px">
                        <h3 style="color: #185ADB;">Info Banner</h3>
                    </div>
                    <table >
                        <thead >
                            <tr style="color: blue">
                        ...
                        <?php foreach ($banner as $b) : ?>
                            <tr>
                                ...
                                <td style="padding-right: 15px"><?= $b['created_at'] ?></td>
                                <td>
                                    <span style="margin-right: 10px" class="status process"><a style="text-decoration: none; color: black;" href="dashboard.php?page=banner/editbanner&id=<?= $b['id'] ?>">Edit</a>
                                    </span>
